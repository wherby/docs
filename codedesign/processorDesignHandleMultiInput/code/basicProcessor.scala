package com.pwc.ds.awm.processor.generalExcel

import com.pwc.ds.awm.component.excel.{ExcelField, ExcelToArray}
import com.pwc.ds.awm.processor.morgan.excelreader.MorganExcelGLReader.{glHeader, glHeaderOrg}
...
case class BasicExcelReader(
                             ...
                             readerOpt: Option[String => Seq[Seq[ExcelField]]] = None
                           )
